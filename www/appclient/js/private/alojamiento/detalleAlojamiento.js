...
function cargarDetalle() {
    ...
    httpConnect("http://192.168.137.1:88/alojamiento/" + id, null, "GET", function (r) {
        if (r.status !== 200) {
            alert(r.message);
...
function cargarLugar() {    
    httpConnect("http://192.168.137.1:88/lugar", null, "GET", function (r) {
...
$(function () {
    ...
    $("#btnUpdateAlojamiento").click(function () {
        ...
        var id = $("#id").val();
        httpConnect("http://192.168.137.1:88/alojamiento/" + id, jentidad, "PUT", function (r) {
