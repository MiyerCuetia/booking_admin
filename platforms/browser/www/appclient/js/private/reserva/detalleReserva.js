function cargarDetalle() {
    ...
    httpConnect("http://192.168.0.5:88/reserva/" + id, null, "GET", function (r) {
        if (r.status !== 200) {
            alert(r.message);
...
function cargarCliente() {
    httpConnect("http://192.168.0.5:88/usuario", null, "GET", function (r) {
        for (var i = 0; i < r.data.length; i++) {
            var o = r.data[i];
...
$(function () {
    ...
    $("#btnUpdateReserva").click(function () {
        ...
        var id = $("#id").val();
        /*httpConnect("http://192.168.0.5:88/reserva/" + id, jentidad, "PUT", function (r) {
